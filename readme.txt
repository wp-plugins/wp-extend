...
= 1.1.1 =
* Excluded wpx_fields from search results.

= 1.1.0 =
* Fixed problem with the way the rewrite array in custom cpts/taxonomies is interpreted (for reals).

= 1.0.9 =
* Fixed problem with the way the rewrite array in custom cpts/taxonomies is interpreted.
...
= 1.0.6 =
* Fixed problems with option meta set by custom options pages.
